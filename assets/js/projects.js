...
window.portfolioProjectFallback = {
  ...
  "projects": [
    ...
    },
    {
      ...
      "description": "Prototipo di landing page per palestra che organizza offerta, corsi e call to action in un percorso responsive orientato al contatto.",
      "longDescription": "Versione dimostrativa nata da un concept Figma: mostra progettazione UI, struttura commerciale e sviluppo responsive; contenuti e interazioni sono ancora in evoluzione.",
    ...
    },
    {
      ...
      "type": "AI / Automation",
      "description": "Concept di assistente per attività locali, pensato per rispondere sui servizi e raccogliere le informazioni iniziali di una richiesta.",
