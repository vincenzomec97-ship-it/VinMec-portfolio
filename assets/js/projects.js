  ...
  "projects": [
    {
      ...
      "description": "Sito web completo per impresa locale, aggiornato con dati aziendali ufficiali, footer legale coerente, privacy più chiara, moduli validati e flusso preventivi collegato a Google Apps Script.",
      "longDescription": "Il sito C.M. Pulizie è stato migliorato per essere più adatto a un uso aziendale ufficiale mantenendo design originale e identità visiva. Sono stati aggiornati i dati C.M. SRLS, il footer legale su tutte le pagine, Privacy Policy e Cookie Policy base, checkbox privacy obbligatorie, validazione dei moduli, testi per preventivo, candidatura e pagina aiuto. Il collegamento Google Apps Script per preventivi, email e PDF resta attivo; le sezioni informative sono più complete e da far verificare a un consulente privacy o commercialista se necessario.",
    ...
    },
    {
      ...
      "description": "Piattaforma educativa in sviluppo per creare e svolgere quiz di inglese, con doppio flusso docente/studente, generazione AI, validazione JSON, Supabase e gestione dei risultati.",
      "longDescription": "Web app educativa in sviluppo: punta a gestire creazione quiz, svolgimento da parte degli studenti, feedback, fonti, struttura dati in JSON e supporto AI. Non viene presentata come completata finché non sarà disponibile una demo funzionante.",
      "image": "",
      "imageAlt": "Preview roadmap di English Quiz Lab",
      "tags": [
        "HTML",
        "CSS",
        "JavaScript",
